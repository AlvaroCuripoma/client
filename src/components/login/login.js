...
switch (tipo_error) {
    case '1':
        document.getElementById('cont_msm_llenar_campso').classList.remove('msm_llenar_campso');
        document.getElementById('cont_msm_llenar_campso').classList.add('mostrar');
        localStorage.removeItem('login');
        break;
    case '2':
        document.getElementById('cont_msm_no_usuario').classList.remove('msm_no_usuario');
